...
DEFAULT_STRATEGY_PATH = Path("freqtrade/user_data/strategies/QuantOSDryRunStrategy.py")
...
def export_quant_os_strategy(output_path: str | Path = DEFAULT_STRATEGY_PATH) -> Path:
