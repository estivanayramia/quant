...
DEFAULT_SCAN_PATHS = [
    ...
    Path("src/quant_os/data/weather/current_weather_market_discovery.py"),
    Path("src/quant_os/data/weather/current_weather_forecast_match.py"),
    ...
    Path("src/quant_os/autonomy/current_market_watch_plan.py"),
