...
from quant_os.readiness.autonomy_milestone_report import (
    write_sequence44_autonomy_milestone_report,
)
from quant_os.readiness.pm_crypto_updown_candidate_decision import (
    evaluate_pm_crypto_updown_candidate_decision,
)

REPORT_ROOT = Path("reports/sequence44/candidate_decision")


def write_pm_crypto_updown_candidate_decision_report(
    *,
    ...
    autonomy = write_sequence44_autonomy_milestone_report(
...
def _write_report(payload: dict[str, Any], *, output_root: str | Path) -> dict[str, str]:
    ...
    lines = [
        "# Sequence 44 PM Crypto UP/DOWN Candidate Decision",
        "",
        "Hard candidate decision gate. This is not live or canary readiness.",
        "",
