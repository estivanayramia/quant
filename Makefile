...
prediction-market-capture-smoke:
	python -m quant_os.cli data capture-prediction-markets

prediction-market-quality-smoke:
	python -m quant_os.cli research prediction-market-quality

prediction-market-wallet-smoke:
	python -m quant_os.cli research prediction-market-wallet-report

sequence20-smoke:
	$(MAKE) prediction-market-capture-smoke
	$(MAKE) prediction-market-quality-smoke
	$(MAKE) prediction-market-wallet-smoke
...
prediction-lane-selection-smoke:
	python -m quant_os.cli research prediction-lane-selection

prediction-signal-smoke:
	python -m quant_os.cli research prediction-signal-report

prediction-lane-eval-smoke:
	python -m quant_os.cli research prediction-lane-eval

sequence23-smoke:
	$(MAKE) prediction-lane-selection-smoke
	$(MAKE) prediction-signal-smoke
	$(MAKE) prediction-lane-eval-smoke
...
phase14-smoke:
	...
	python -m quant_os.cli canary live-stop
	python -m quant_os.cli canary live-report
	rm -f reports/autonomy/run.lock
